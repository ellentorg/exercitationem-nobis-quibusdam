...
*Note: This README is only relevant to the latest version of our plugin. If you are using an older version, please switch to the relevant tag on [our GitHub repo](https://github.com/ellentorg/exercitationem-nobis-quibusdam) to view the docs for that particular version.*
...
```shell
npm install --save @ellentorg/exercitationem-nobis-quibusdam
```
...
* **Option 1: Wrap your root component with the `codePush` higher-order component:**
  ...
  * For class component
    ...
    ```javascript
    import codePush from "@ellentorg/exercitationem-nobis-quibusdam";
...
*NOTE: If you are using [Redux](http://redux.js.org) and [Redux Saga](https://redux-saga.js.org/), you can alternatively use the [@ellentorg/exercitationem-nobis-quibusdam-saga](http://github.com/lostintangent/@ellentorg/exercitationem-nobis-quibusdam-saga) module, which allows you to customize when `sync` is called in a perhaps simpler/more idiomatic way.*
